import { CategoryService } from 'src/packages/models';
...
export class CategoryController {
  ...
  async create(@Body() object: CategoryCreateRequestDto) {
    return this.service.create(object);
  }

  @Put(':id')
  @ApiResponse({ status: 200 })
  async updateById(@Param('id') id: string, @Body() object: CategoryUpdateRequestDto) {
